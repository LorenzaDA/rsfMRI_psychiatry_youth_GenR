#####################################
# 10. dichotomous int/ext static FNC
####################################
# analysis addressing peer review comment of testing with 
# int and ext too 
...
# less good than for continuous vars
...
all <- rbind(out_BrtoBeh, out_BehtoBr)

write.csv(all, paste0(tab, "results_sens_dichotomized_intext_static.csv"))
