##########################
# 10. Sensitivity - dichotomous int/ext 
##########################
# peer review comment on testing whether same 
# results when int and ext dichotomized 
...
# Dichotomize int/ext
#####
# based on cut off of 65 in t-scores

dd$int_t2 <- ifelse(dd$internalizing_problems_tscore_14 < 65, dd$internalizing_problems_tscore_14 <- 0, dd$internalizing_problems_tscore_14 <- 1)
dd$int_t1 <-ifelse(dd$internalizing_problems_tscore_9m < 65, dd$internalizing_problems_tscore_9m <- 0, dd$internalizing_problems_tscore_9m <- 1)
dd$ext_t2 <-ifelse(dd$externalizing_problems_tscore_14 < 65, dd$externalizing_problems_tscore_14 <- 0, dd$externalizing_problems_tscore_14 <- 1)
dd$ext_t1 <- ifelse(dd$externalizing_problems_tscore_9m < 65, dd$externalizing_problems_tscore_9m <- 0, dd$externalizing_problems_tscore_9m <- 1)

# NB now the vars are still numeric. that's how it should be for lavaan
# to be able to use them as endogenous var
...
write.csv(table_fits, paste0(tab, "model_fits_sens_dichotomous.csv"))
# model fits are not as good as in  models with continous measures - they dropped 
...
# rename for output table to be cleaner
...
write.csv(out2, paste0(tab, "results_sens_dichotomous.csv"))
